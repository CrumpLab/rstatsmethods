---
title: "Lab 3 Distributions I"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Lab 3 Distributions I}
...
We are about to spend three entire labs devoted to understanding and working with distributions. We will cover topics that closely relate to the main statistics lecture, but also take advantage of R to examine distributions in more direct and hands manner that is not possible without a programming environment.
