...
vignette: >
  %\VignetteIndexEntry{Lab 10 t tests}
...
hist(sim_mean_diffs, breaks=100)
```
...
```{r}
sim_ps <- replicate(1000, t.test(replicate(20, mean(rnorm(10000, 0, 1))),
                                 replicate(20, mean(rnorm(10000, .01, 1))),
                                 var.equal = TRUE)$p.value)
#hist(sim_ps,breaks=20)
length(sim_ps[sim_ps < .05])/1000


b <- t.test(replicate(20, mean(rnorm(10000, 0, 1))),
                                 replicate(20, mean(rnorm(10000, .01, 1))),
                                 var.equal = TRUE)
...
GA <- replicate(20, mean(rnorm(1000000, 0, 1)))
GB <- replicate(20, mean(rnorm(1000000, .01, 1)))
...
```{r}
effect_sizes <- seq(0,1,.1)
prop_significant <-c()

for(i in 1:length(effect_sizes)){
  sim_ps <- replicate(1000, t.test(replicate(20, mean(rnorm(15, 0, 1))),
                                   replicate(20, mean(rnorm(15, effect_sizes[i], 1))),
                                   var.equal = TRUE)$p.value)
