---
title: "Lab 9 Chi Square"
bibliography: references.bib
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Lab 9 Chi Square}
...
1. The following paper links to open data, and describes a design where two chi-square tests are performed for Experiment 1 (A copy of this paper will be available on blackboard).
...
Obtain the data from the online repository, show your code for loading it into R, then conduct the same chi-square tests reported in Experiment 1 that the authors conducted. Briefly report your re-analysis, and discuss whether you obtained the same values as the authors did (6 points). 
