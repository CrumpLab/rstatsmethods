...
vignette: >
  %\VignetteIndexEntry{Lab 9 RM ANOVA}
...
2. Run a simulation to determine the proportion of experiments that would return a significant result for the above design. Assume alpha = .05. (2 points)
