...
Remember, in a one-factor ANOVA, by definition the number of type errors made by the null should be the same as the alpha criterion, or 5% in our case. Will this also be true for the 2x2 factorial ANOVA?
...
```{r}
length(save_sim$p_vals[save_sim$p_vals < .05])/10000
```
