...
If the pigeon correctly chose the truck 100% of the time over 10 different choices, I would statrt to think maybe the pigeon "knows" something. This is because I know it would be more unlikely to get "10-in-a-row" by chance. 
...
Consider performance levels in a choice task around 55% correct, which is close to 50%. Just because 55% is close to chance, you might think that chance could easily produce 55% correct. However, the ability of chance to produce 55% correct depends on the number of trials in the experiment. 
