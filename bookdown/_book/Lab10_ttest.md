...
## 
## data:  A_means and B_means
## t = 0.25703, df = 18, p-value = 0.8001
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.8505687  1.0877038
## sample estimates:
##  mean of x  mean of y 
## 0.19476657 0.07619903
```
...
## 
## data:  A and B
## t = 1.8299, df = 15.671, p-value = 0.08635
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.1277285  1.7198322
## sample estimates:
...
## 
## data:  A and B
## t = 1.8299, df = 18, p-value = 0.08388
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.1178945  1.7099982
## sample estimates:
...
```
## $estimate
## [1] "$\\Delta M = 0.80$, 95\\% CI $[-0.12$, $1.71]$"
## 
## $statistic
## [1] "$t(18) = 1.83$, $p = .084$"
## 
## $full_result
## [1] "$\\Delta M = 0.80$, 95\\% CI $[-0.12$, $1.71]$, $t(18) = 1.83$, $p = .084$"
## 
## $table
## NULL
## 
...
## [1] "apa_results" "list"
```
For example, this t-test result, $t(18) = 1.83$, $p = .084$, was printed using an r code snippet inserted into the text of this .Rmd.
...
## t = -0.79291, df = 18, p-value = 0.4382
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -20.866777   9.431809
## sample estimates:
...
## t = -0.090657, df = 18, p-value = 0.9288
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -15.36341  14.09236
## sample estimates:
...
<img src="Lab10_ttest_files/figure-html/unnamed-chunk-15-1.png" width="672" />
...
<img src="Lab10_ttest_files/figure-html/unnamed-chunk-16-1.png" width="672" />
...
<img src="Lab10_ttest_files/figure-html/unnamed-chunk-17-1.png" width="672" />
...
<img src="Lab10_ttest_files/figure-html/unnamed-chunk-18-1.png" width="672" />
...
<img src="Lab10_ttest_files/figure-html/unnamed-chunk-20-1.png" width="672" />
...
<img src="Lab10_ttest_files/figure-html/unnamed-chunk-21-1.png" width="672" />
...
<img src="Lab10_ttest_files/figure-html/unnamed-chunk-22-1.png" width="672" />
